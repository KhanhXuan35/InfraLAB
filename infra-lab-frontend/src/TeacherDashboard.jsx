                ...
                activities.map((activity) => {
                  ...
                  return (
                    <div key={activity.id} className="activity-item">
                      <span className={`activity-dot ${className}`}>
                        {icon}
                      </span>
          ...
          <div>
            ...
            <div className="quick-actions">
              <div className="quick-actions-row">
                <button className="qa-btn qa-blue">
                  + Yêu cầu thêm thiết bị
                </button>
                <button className="qa-btn qa-purple">
                  ↔ Ghi nhận mượn/trả
                </button>
              </div>
              <div className="quick-actions-row">
                <button className="qa-btn qa-yellow">
                  🔍 Tìm kiếm thiết bị
                </button>
